...
(defvar fixed-pitch-families
  '("IBM Plex Mono" "SF Mono" "Consolas")
...
(setq
 fixed-pitch-family (first-available-font fixed-pitch-families)
 variable-pitch-family (first-available-font variable-pitch-families))
...
(create-fontset-from-fontset-spec
 (concat "-*-"
         fixed-pitch-family
         "-normal-normal-normal-*-12-*-*-*-m-0-fontset-custom"))
